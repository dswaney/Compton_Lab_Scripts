...
.NOTES
    ...
    ScriptVersion: 4.4.0
    Change: Adds Script 07 AtStartup resume task and retires the two duplicate fixed-time Script 07 follow-up tasks.
...
try {
    ...
    $taskDefinitions = @(
        ...
        [pscustomobject]@{ Name='17. Install Elastic Agent';                 Script='15_Install_Elastic_Agent.ps1';                        Time='08:30'; Args='' },
        [pscustomobject]@{ Name='19. Configure Browser Homepage';            Script='17_Set_Browser_Homepage.ps1';                        Time='08:40'; Args='' },
        [pscustomobject]@{ Name='20. Install Honorlock Chrome Extension';    Script='18_Install_Honorlock_Chrome_Extension.ps1';           Time='08:45'; Args='' }
    )
    ...
    $rebootResumeStartupTaskName = '08A. Resume Reboot Verification at Startup'
    $deepFreezeStartupTaskName = '18. Check Deep Freeze Status at Startup'
